...
const Open = (data) => {
  ...
  $("#total-players").html("<p>"  + data.maxPlayers + " / " + data.players + "</p>");
...
const Setup = (data) => {
  ...
  scoreboardHtml += `
    <div class="scoreboard-info-beam" style="background: linear-gradient(90deg, rgba(0,248,184,0) 0%, rgba(0,248,184,0.3) 50%, rgba(0,248,184,0) 100%); margin-top:140%;">
